...
<body>
	<form:form id="inputForm" modelAttribute="resource" action="${ctx}/system/resource/save" method="post" class="form-horizontal" role="form">
		<fieldset>
			<legend><fmt:message key="add"/><fmt:message key="resource"/></legend>
