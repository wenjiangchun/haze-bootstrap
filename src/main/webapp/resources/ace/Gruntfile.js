        ...
        uglify: {
            ...
            ace: {
                files: [{
                    ...
                    dest: 'dist/js',
                    ext: function (name) {
                        return name.replace(/(\.src)?\.js$/i, '.min.js');
                    }
                }]
            },
        ...
        cssmin: {
            ...
            all: {
                files: [{
                    ...
                    dest: 'dist/css',
                    ext: function (ext) {
                        return ext.replace(/\.css$/i, '.min.css');
                    }
                }]
            }
        },
        ...
        compress: {
            ...
            template: {
                ...
                files: [
                    {
                        cwd: './',
                        src: ['changelog', 'credits.txt', 'dummy.html', 'Gruntfile.js', 'index.html', 'package.json'],
                        dest: '.'
                    },
                    ...
                    {expand: true, cwd: './html', src: ['**'], dest: './html'},
                    {
                        expand: true,
                        cwd: './mustache',
                        src: ['**', '!**/node_modules/**', '!**/_cache/*.php', '!**/Copy **'],
                        dest: './mustache'
                    }
                ]
            }
